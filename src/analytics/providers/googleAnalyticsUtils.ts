...
const PRIVATE_KEY = env.GOOGLE_ANALYTICS_PRIVATE_KEY
  ? Buffer.from(env.GOOGLE_ANALYTICS_PRIVATE_KEY as string, "base64").toString("utf-8")
  : "";

const analyticsDataClient = new BetaAnalyticsDataClient({
  credentials: {
    client_email: env.GOOGLE_ANALYTICS_CLIENT_EMAIL as string | undefined,
